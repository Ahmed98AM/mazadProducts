                ...
                {({ isSubmitting, setFieldValue, values }) => (
                    <Form className='w-full flex flex-col gap-5 p-7'>
                        <div>
                            ...
                            <Field id="category" className="w-full text-[0.7em] h-[3em] rounded-md cursor-pointer my-1 px-2" onChange={(e: React.ChangeEvent<HTMLSelectElement>) => { 
                        ...
                        <div>
                            ...
                            <Field className="w-full text-[0.7em] h-[3em] rounded-md cursor-pointer my-1 px-2" id="subCategory" onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
                                const selectedIndex = e.target.selectedIndex;
                                const selectedOptionKey = e.target.options[selectedIndex].getAttribute('data-id');
                        ...
                        <div className="w-full flex flex-col gap-5">
                            ...
                            subCategoryOptionsData?.map((property, i) => (
                                <div key={property.id}>
                                    ...
                                    <Field className="w-full text-[0.7em] h-[3em] rounded-md cursor-pointer my-1 px-2" id={property.id.toString()} as="select" name={property.name} label={`Select ${property.name}`}  
